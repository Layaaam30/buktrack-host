...
/// Account Model for Drivers and Conductors
/// Matches Firestore structure exactly
class Account {
  final String id;
  final String name;
  ...
  // Status fields
  final String
  availabilityStatus; // 'available', 'in_transit', 'on_leave', 'unavailable'
  final bool isActive;
  ...
  // Firebase fields (for mobile app authentication)
  ...
  /// Convert Account to Firestore document
  ...
  /// Check if account is assigned to a bus
  bool get isAssigned => assignedBusId != null && assignedBusId!.isNotEmpty;

  /// Check if account is on leave
  bool get isOnLeave {
